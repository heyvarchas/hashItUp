...
class TestScoringOnDataWrites(unittest.TestCase):
    ...
    def tearDownClass(cls):
        cls.db.execute(text("DELETE FROM analytics.alerts WHERE risk_score_id IN (SELECT id FROM analytics.risk_scores WHERE pseudonymous_id = :pid)"), {"pid": cls.test_pid})
